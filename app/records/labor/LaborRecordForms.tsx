...
import type { Labor } from "./columns"
...
export function DataTable({ columns, data, loading, refreshLabor }: DataTableProps) {
      ...
      if (col.id === "actions") {
        return {
          ...
          cell: ({ row }: any) => {
            ...
            return <EditLaborDialog labor={labor} onLaborUpdated={() => refreshLabor()} />
          },
        }
      }
      return col
        ...
        <div className="flex items-center gap-2">
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
              <Button variant="outline" className="bg-black text-white hover:bg-gray-700 hover:text-white">
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>Add labor details here. Click Submit when you're done.</DialogDescription>
              </DialogHeader>
        ...
        <Table>
          ...
          <TableBody>
            {table.getRowModel().rows.length ? (
              ...
              <TableRow>
                <TableCell colSpan={updatedColumns.length} className="h-24 text-center">
                  No results.
                </TableCell>
              </TableRow>
            )}
