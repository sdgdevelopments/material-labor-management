...
export default function AddLaborForm({
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      const total_cost = Number.parseFloat((values.cost * values.quantity).toFixed(2))
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-full mx-auto py-6 px-4">
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} value={field.value || ""}>
                  ...
                  <SelectContent>
                    <SelectItem value="Management and Supervision">Management and Supervision</SelectItem>
                    ...
                    <SelectItem value="Painting and Finishing">Painting and Finishing</SelectItem>
                    <SelectItem value="Heavy Equipment Operators">Heavy Equipment Operators</SelectItem>
                    <SelectItem value="Safety and Inspection">Safety and Inspection</SelectItem>
